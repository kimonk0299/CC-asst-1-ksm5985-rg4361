...
$(document).ready(function() {
  ...
  $(window).load(function() {
    ...
    insertResponseMessage('Hi there, I\'m your personal Concierge created by Kishore and Rithivk, How can I help you?');
  });
  ...
  function callChatbotApi(message) {
    ...
    console.log("HIIIIIIII KIIKII")
    console.log(message)
    console.log(sdk.chatbotPost({}, 
      {
        "type" : "object",
        "properties" : {
          "messages" : {
    ...
    callChatbotApi(msg)
      .then((response) => {
        ...
        if (data.messages && data.messages.length > 0) {
          ...
          insertResponseMessage('Oops, something went wrong. Please try again. or Re-type your query again');
        }
      })
      .catch((error) => {
