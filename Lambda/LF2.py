...
def findRestaurantFromElasticSearch(cuisine):
    region = 'us-east-1'
    service = 'es'
    credentials = boto3.Session(aws_access_key_id="AKIA4J6KABAGXUV6X5E3",
                          aws_secret_access_key="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", 
                          region_name="us-east-1").get_credentials()
    awsauth = AWS4Auth(credentials.access_key, credentials.secret_key, region, service, session_token=credentials.token)
    host = 'search-rithvikchatbot-be7jjxxxug67ybvhvce4kpx2au.us-east-1.es.amazonaws.com'
    index = 'rithvikchatbot'
